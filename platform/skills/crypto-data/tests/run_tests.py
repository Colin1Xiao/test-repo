...
def main():
    parser = argparse.ArgumentParser(description="运行 Crypto Data 技能测试")
    ...
    if args.list:
        print("可用测试:")
        suite = discover_tests()
        for test in unittest.TestLoader().getTestCaseNames(suite):
            print(f"  - {test}")
        return 0
    
    print("="*60)
    print("Crypto Data Skill Test Suite")
    print("="*60)
    print()

...
import { getIncidentRepository, IncidentStatus } from '../alerting/incident_repository.js';
import { getIncidentFileRepository } from '../persistence/incident_file_repository.js';

export function createAlertingRoutes(): Router {
  const router = Router();
  ...
  router.post('/ingest', async (req: Request, res: Response) => {
    const alert_name: string = req.body.alert_name;
    const alert_value: string | undefined = req.body.alert_value;
    const resource: string | undefined = req.body.resource;
    const correlation_id: string | undefined = req.body.correlation_id;
    const metadata: Record<string, unknown> | undefined = req.body.metadata;
  ...
  router.post('/:id/acknowledge', async (req: Request, res: Response) => {
    const alert_id: string = req.params.id as string;
    const reason: string | undefined = req.body.reason;
    const performed_by: string | undefined = req.body.performed_by;
  ...
  router.post('/:id/link-incident', async (req: Request, res: Response) => {
    const alert_id: string = req.params.id as string;
  ...
  router.post('/:id/open-runbook', async (req: Request, res: Response) => {
    const alert_id: string = req.params.id as string;
    const performed_by: string | undefined = req.body.performed_by;
  ...
  router.get('/incidents', async (req: Request, res: Response) => {
    ...
    const status: IncidentStatus | undefined = typeof statusParam === 'string' ? statusParam as IncidentStatus : undefined;

...
export function createTradingRoutes() {
    ...
    // ==================== Recovery ====================
    router.post('/recovery/scan', async (req, res) => {
    ...
    // ==================== Webhook ====================
    router.post('/webhooks/:provider/ingest', async (req, res) => {
        const provider = req.params.provider;
        const event = req.body.event;
        const data = req.body.data;
        const eventId = req.headers['x-event-id'] || `event-${Date.now()}`;
    ...
    // ==================== Policy Audit ====================
    router.get('/policy-audit', async (req, res) => {
...
//# sourceMappingURL=trading_routes.js.map
...
description: Zhipu AI Web Search Tool - Provides flexible search engine capabilities directly via cURL. Supports Quark, Sogou, and Zhipu Search engines with time range and domain filtering.
metadata:
  openclaw:
    emoji: 🔍
    version: 1.0.0

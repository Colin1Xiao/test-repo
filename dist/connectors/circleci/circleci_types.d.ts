 ...
 */
export type CircleCIEventType = 'workflow_started' | 'workflow_completed' | 'workflow_failed' | 'workflow_on_hold' | 'job_started' | 'job_completed' | 'job_failed' | 'job_on_hold' | 'approval_pending';
export type CircleCIStatus = 'success' | 'failed' | 'error' | 'on_hold' | 'canceled' | 'unauthorized' | 'not_run' | 'infrastructure_fail' | 'running';

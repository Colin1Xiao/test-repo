...
export type OperatorViewKind = "dashboard" | "tasks" | "approvals" | "incidents" | "agents" | "inbox" | "interventions" | "history" | "item_detail";
export type OperatorMode = "summary" | "detail" | "operator" | "management" | "incident" | "approval_focus" | "agent_focus";
export type OperatorActionType = "view_dashboard" | "view_tasks" | "view_approvals" | "view_incidents" | "view_agents" | "view_inbox" | "view_interventions" | "view_history" | "open_item" | "switch_workspace" | "approve" | "reject" | "escalate" | "ack_incident" | "request_recovery" | "request_replay" | "retry_task" | "cancel_task" | "pause_task" | "resume_task" | "pause_agent" | "resume_agent" | "inspect_agent" | "confirm_action" | "dismiss_intervention" | "snooze_intervention" | "go_back" | "refresh";
export type OperatorTargetType = "dashboard" | "task" | "approval" | "incident" | "agent" | "intervention" | "workspace" | "history" | "inbox" | "unknown";
export type OperatorConfirmationState = "none" | "pending" | "confirmed" | "cancelled";

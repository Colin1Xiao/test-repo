...
export type ImportantFileType =
  | 'package_manifest'    // package.json, pyproject.toml
  | 'config'              // tsconfig.json, vite.config.ts
  | 'entrypoint'          // main.ts, app.py
  | 'test_config'         // jest.config.js, pytest.ini
  | 'build_config'        // webpack.config.js, Cargo.toml
...
// ============================================================================
// Symbol Intelligence Types (Sprint 2B)
// ============================================================================
